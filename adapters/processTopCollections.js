    ...
    try{
        ...
        for(let obj of processedResp){
           ...
           let newObj = {...obj,
            ...
            topBidInEth:"0",
            noOfOwners: singleExchangeResp?.stats?.num_owners?singleExchangeResp.stats.num_owners:"",
            supply: singleExchangeResp?.stats?.total_supply?singleExchangeResp.stats.total_supply:"",
            };
...
module.exports={processTopCollectionsDataToDbFormat};